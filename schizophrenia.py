...
ending = ('thing','-o-mat','-o-meter','destroyer','tool','box','burger','salad','cola','fruit','cat','dog','bird','frog','pulsar','beam','particle','wave','accelerator','matter','void','bullshit')
start = ('black','white','red','green','yellow','blue','cyan','fap','zap','flap','clap','crap','carp','robo','auto','electro','quantum','recta','hexa','hollow','light','heavy','super','mega','fancy','secret','bloody','murder','bone','metal','wooden','stone','glass','soft','hard','hot','cold','liquid','solid')
